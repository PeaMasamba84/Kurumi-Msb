...
async def initiate_help_messages():
    mirror, yt, clone = await gather(
        telegraph.create_page(
            title="Bantuan Mirror Leech Pea Masamba Bot", content=MIRROR_HELP_MESSAGE
        ),
        telegraph.create_page(
            title="Bantuan YT-DLP Pea Masamba Bot", content=YT_HELP_MESSAGE
        ),
        telegraph.create_page(
            title="Bantuan Clone Pea Masamba Bot", content=CLONE_HELP_MESSAGE
        ),
    )
    buttons = ButtonMaker()
