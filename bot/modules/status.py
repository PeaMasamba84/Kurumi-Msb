...
async def mirror_status(_, message):
    ...
    if count == 0:
        ...
        try:
            ...
            recv = "NaN"
        msg = "<b>Kosong bro!</b>"
        msg += f"\n<b>Note :</b> Setiap User bisa tampilkan Tugasnya dengan menambah <code>me</code> atau <code>user_id</code> setelah perintah <code>/{BotCommands.StatusCommand[0]}</code>!"
